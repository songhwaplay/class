...
assert.ok(teacher.includes('clockRateHoursPerSecond||8'));
assert.ok(student.includes('n===1?10:n===2?5:n===3?3:1'));
console.log(JSON.stringify({ok:true,panamaPacificOnly:true,portTouchRadiusTiles:radius,gameHoursPerRealSecond:8,rewards:[10,5,3]}));
