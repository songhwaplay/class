...
for(const token of ['/js/wind.js','windCloudAtlas','/assets/weather/cloud_original_12frames.png','drawWindClouds','WIND_CLOUD_FRAME_W','WIND_CLOUD_SEQUENCE_FRAMES=6','sequenceBase=small?6:0','windHud','WIND_VISUAL_FLOW_RATE=4.2','WIND_CLOUD_FRAME_MS=72']){
