(function () {
  ...
  window.MUSEUM_ROOMS = [
    ...
    },
    {
      ...
      works:[
        art('d13','광화문 해치(서쪽)','작자 미상','조선 후기','화강암',{w:275.6,h:350.7,d:186.2,label:'길이 275.6cm × 너비 186.2cm × 높이 350.7cm'},'d13.jpg','광화문 앞을 지키는 상상의 동물 해치예요. 옳고 그름을 가리고 불과 나쁜 기운을 막는 수호 동물로 여겨졌습니다.','옆으로 돌아가며 둥근 눈과 코, 갈기와 몸을 덮은 소용돌이무늬가 어떻게 이어지는지 살펴보세요.',{type:'sculpture',actualScale:true,hasBuiltInBase:true,centerModel:true,preserveMaterials:true,materialTint:0x817d75,modelRotationY:0,rights:'3D 모델: 국가유산청, CC BY 4.0 · 사진: hyolee2, CC BY-SA 3.0',source:'https://sketchfab.com/3d-models/gwanghwamun-gate-haetaea-e11f9ee66df74288be83f9fede578bd4'}),
        ...
        art('d05','밀로의 비너스','알렉산드로스 추정','기원전 150–125년경','대리석',{w:80,h:204,d:65,label:'높이 204cm'},'d05.jpg','몸의 무게를 한쪽 다리에 싣고 상체를 반대로 틀어 부드러운 S자 균형을 만들었어요.','어깨와 골반이 서로 어느 방향으로 기울었는지 비교해 보세요.',{type:'sculpture',centerModel:true,applyRoomOffset:true,rights:'원작 Public Domain · 3D Scan: Scan the World, CC BY-SA 4.0',source:'https://collections.louvre.fr/en/ark:/53355/cl010277627'}),
