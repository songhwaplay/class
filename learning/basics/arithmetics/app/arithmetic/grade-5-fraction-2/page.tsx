...
import { createGradeFiveFractionTwoSet } from "../../../lib/grade-five-fraction-two";
import type {
  GradeFiveFractionTwoOperand,
  GradeFiveFractionTwoProblem,
} from "../../../lib/grade-five-fraction-two";
...
function Operand({ value }: { value: GradeFiveFractionTwoOperand }) {
  return (
    <span className="grade-five-fraction-one-value mixed">
      {value.kind === "mixed" && <strong>{value.whole}</strong>}
...
export default function GradeFiveFractionTwoPage() {
  ...
  const problemSet = useMemo(() => createGradeFiveFractionTwoSet(seed), [seed]);
  ...
  function isAnswerCorrect(problem: GradeFiveFractionTwoProblem) {
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className="a4-sheet counting-sheet grade-five-fraction-one-sheet grade-five-fraction-two-sheet" style={{ transform: `scale(${sheetScale})` }}>
