...
import { createStatisticalInferenceProblems, statisticalInferenceProblems } from "../../../../lib/statistical-inference-workouts";
...
export default function StatisticalInferencePage() {
  return (
    <GeometryChoiceWorksheet
      ...
      createProblems={createStatisticalInferenceProblems}
    />
  );
}
