...
export const projectionProblems: GeometryChoiceItem[] = [
  ...
  item("p4", "스칼라 정사영", String.raw`\vec a=(3,4),\ \vec b=(4,0)\quad \operatorname{comp}_{\vec b}\vec a=\frac{\vec a\cdot\vec b}{|\vec b|}=?`, String.raw`3`, [String.raw`4`, String.raw`\frac{12}{5}`, String.raw`12`]),
