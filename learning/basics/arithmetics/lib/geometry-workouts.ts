...
const geometryPromptById: Record<string, string> = {
  ...
  v2: "벡터의 크기는?",
  v3: "벡터의 계산 결과는?",
  v4: "벡터 $\\vec a$와 같은 방향의 단위벡터는?",
  v5: "두 벡터가 평행할 때 $k$는?",
  v6: "위치벡터 $\\overrightarrow{OB}$는?",
  v7: "내분점 $P$의 위치벡터는?",
  p1: "두 벡터의 내적은?",
  p2: "두 벡터가 수직일 때 $k$는?",
  p3: "두 벡터가 이루는 각 $\\theta$는?",
  p4: "벡터 $\\vec a$의 $\\vec b$ 방향 스칼라 정사영은?",
  p5: "벡터 $\\vec a$의 $\\vec b$ 위로의 정사영은?",
  p6: "벡터 $\\vec a$의 $\\vec b$에 수직인 성분은?",
  p7: "벡터 $\\vec a$가 $x$축과 이루는 각의 코사인값은?",
  g1: "직선의 방향벡터는?",
  g2: "직선의 법선벡터는?",
  g3: "점 $P$를 지나고 방향벡터 $\\vec d$와 평행한 직선의 벡터방정식은?",
  g4: "점 $P$와 직선 사이의 거리는?",
  g5: "삼각형 $ABC$의 넓이는?",
  g6: "점 $P$에서 $x$축에 내린 수선의 발 $H$는?",
  g7: "두 직선이 수직일 때 $k$는?",
};
