...
assert.ok(student.includes('n===1?1.3:n===2?1.2:n===3?1.1:1'));
console.log(JSON.stringify({ok:true,panamaPacificOnly:true,portTouchRadiusTiles:radius,gameHoursPerRealSecond:30,rewards:[1.3,1.2,1.1]}));
