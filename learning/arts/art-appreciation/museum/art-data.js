(function () {
  ...
  const META = {
    ...
    p05:{englishTitle:'The Scream',tags:['상징주의','표현주의에 끼친 영향'],styleNote:'뭉크는 불안이라는 보이지 않는 감정을 구불거리는 선과 강렬한 색으로 바꾸어 보여 주었고, 이런 표현은 뒤의 표현주의 화가들에게 큰 영향을 주었어요.'},
    ...
    p12:{englishTitle:'The Fifer',tags:['근대 회화','인물화'],styleNote:'마네는 전통적인 입체감과 배경 묘사를 줄이고 선명한 색면과 인물 자체에 집중했어요. 이런 새로운 화면은 인상주의가 등장하는 데에도 중요한 자극이 되었어요.'},
    ...
    n04:{englishTitle:'Sunflowers',tags:['후기 인상주의','정물화'],styleNote:'반 고흐는 꽃을 사실처럼 옮기는 데 그치지 않고, 여러 노란색과 도드라진 붓질로 꽃의 생명력과 자신이 느낀 따뜻함을 표현했어요.'},
    ...
    c09:{englishTitle:'The Treachery of Images',tags:['초현실주의','이미지와 언어','낯설게 하기'],styleNote:'사실적으로 그린 이미지와 이를 부정하는 문장을 충돌시켜 그림·말·실제 사물이 같은 것인지 질문해요.'},
