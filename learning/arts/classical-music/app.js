const pieces = [
  ...
  ['23','modern','20세기','목신의 오후에의 전주곡','드뷔시','교향시','플루트','자유로운 박자','매우 느리게','몽환적이고 신비롭게','경계가 흐릿한 화음과 유연한 플루트 선율','인상주의','빛과 분위기처럼 순간의 인상을 표현'],
  ['24','modern','20세기','행성 〈목성〉','홀스트','관현악 모음곡','관현악','3박자','빠르게','웅장하고 즐겁게','힘찬 춤 리듬과 넓게 노래하는 중간 선율','관현악법','다양한 악기 음색을 풍부하게 배치'],
  ['25','modern','20세기','피터와 늑대','프로코피예프','음악 동화','관현악과 해설','4박자','보통 빠르게','재치 있고 이야기하듯','등장인물마다 다른 악기와 주제를 사용','라이트모티프','인물이나 생각을 나타내는 반복 주제'],
  ['26','modern','20세기','청소년을 위한 관현악 입문','브리튼','변주곡과 푸가','관현악','3박자','빠르게','선명하고 교육적으로','악기군별 변주 뒤 모든 악기가 푸가로 합류','푸가','주제가 여러 성부에서 차례로 모방'],
  ['27','baroque','바로크','메시아 〈할렐루야〉','헨델','오라토리오','합창과 관현악','4박자','빠르게','장엄하고 환희에 차게','합창이 반복하는 “할렐루야”와 힘찬 화음','합창','성경 이야기를 바탕으로 한 대규모 성악곡'],
  ['28','classical','고전','피아노 소나타 11번 〈터키 행진곡〉','모차르트','피아노 소나타','피아노','2박자','빠르게','경쾌하고 또렷하게','행진을 닮은 리듬과 빠른 오른손 선율','론도','반복되는 주제가 여러 부분 사이에 돌아옴'],
